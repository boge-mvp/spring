...
/**
 * 将生成的时间戳本地化
 * @see org.apache.logging.log4j.core.layout.HtmlLayout
 */
@Plugin(name = "MailHtmlLayout", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public final class HtmlLayout extends AbstractStringLayout {
    ...
    public byte[] getHeader() {
        ...
        datePatternConverter.format(System.currentTimeMillis(), sbuf);
        appendLs(sbuf, "<br>");
        appendLs(sbuf, "<br>");
        appendLs(sbuf,
